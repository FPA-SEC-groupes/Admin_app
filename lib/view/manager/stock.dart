...
class _StockState extends State<Stock> {
  ...
  Future<List<PrimaryMaterial>> _getStockBySpaceId() async {
    List<PrimaryMaterial> stock = await _stockViewModel.getPrimaryMaterialsByIdSpace();
    return stock;
  }
                      ...
                      await showDialog(
                          ...
                          builder: (BuildContext context) {
                            return CustomAlertDialog(
                                title: AppLocalizations.of(context)!.deleteFromStockDialogTitle,
                                message: AppLocalizations.of(context)!.deleteFromStockMessage,
                                submit: () async {
                                  await _stockViewModel
                                      .removePrimaryMaterialFromSpace(primaryMaterial.id!)
                                      .then((space) async {
                                    setState(() {
                                      _getStockBySpaceId();
                                    });
