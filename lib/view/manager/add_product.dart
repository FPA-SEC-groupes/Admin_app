                      ...
                      if (_addProductFormKey.currentState!.validate()) {
                        ...
                        if (widget.product == null) {
                          ...
                          await _addProductViewModel
                              .addProductByIdCategory(_selectedCategoryId!, product)
                              .then((product) async {
                            if (_galleryViewModel.image != null) {
                              await _addProductViewModel
                                  .uploadImage(_galleryViewModel.image!, product.idProduct)
                                  .then((_) {
                            ...
                            if (error is DioError) {
                              if (error.response?.statusCode == 400) {
                                // Update errorText and trigger UI update
                                setState(() {
                                  errorText = AppLocalizations.of(context)!
                                      .productAlreadyExists; // Localization for the error
                                });
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(AppLocalizations.of(context)!
                                        .productAlreadyExists), // Show error in Snackbar
                          ...
                          widget.product!.productTitle =
                              _titleProductController.text.trim().toString();
                          ...
                          await _addProductViewModel
                              .updateProduct(widget.product!, widget.product!.idProduct!)
                              .then((product) async {
                            if (_galleryViewModel.image != null) {
                              await _addProductViewModel
                                  .uploadImage(_galleryViewModel.image!,
