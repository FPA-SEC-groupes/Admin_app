...
class _AddPartyEventState extends State<AddPartyEvent> {
  ...
  String? _validateEndDate(String? value) {
    DateTime startDate = DateTime.parse(_startDateController.text.trim().toString());
                          ...
                          children: [
                            ...
                            Focus(
                              onFocusChange: (hasFocus) {
                                setState(() {
                                  suffixColor = hasFocus ? orange : Colors.grey;
                                });
                              },
                              child: TextFormField(
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                              ...
                                              TextButton(
                                                onPressed: () async {
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (context) => DisplayPartyImage(
                                                        image: _galleryViewModel.image!,
                                                      ),
                                                    ),
                                                  );
                                                },
                                                child: Text(
                                                  _galleryViewModel.image!.path.split("/").last,
                                            ...
                                            TextButton(
                                              onPressed: () async {
                                                bool isGranted = await galleryViewModel.requestGalleryPermission(context);
                                                if (isGranted) {
